...
var modifier = typeof window !== 'undefined' &&
    window.navigator.platform.toLowerCase().indexOf('mac') === 0 ? (react_1.default.createElement("code", { className: "graphiql-key" }, "Cmd")) : (react_1.default.createElement("code", { className: "graphiql-key" }, "Ctrl"));
function GraphiQLInterface(props) {
    ...
    var handleVariablesTabClick = (0, react_1.useCallback)(function () {
        if (editorToolsResize.hiddenElement === 'second') {
            editorToolsResize.setHiddenElement(null);
        }
        setActiveSecondaryEditor('variables');
    }, [editorToolsResize]);
    var handleHeadersTabClick = (0, react_1.useCallback)(function () {
        if (editorToolsResize.hiddenElement === 'second') {
            editorToolsResize.setHiddenElement(null);
        }
    ...
    var handleDismissShortKeysDialog = (0, react_1.useCallback)(function () {
        setShowDialog(null);
    }, []);
    var handleDismissSettingsDialog = (0, react_1.useCallback)(function () {
        setShowDialog(null);
                    ...
                    react_1.default.createElement("div", { role: "tabpanel", id: "graphiql-session", className: "graphiql-session", "aria-labelledby": "graphiql-session-tab-".concat(editorContext.activeTabIndex) },
                        ...
                        react_1.default.createElement("div", { ref: editorResize.secondRef },
                            react_1.default.createElement("div", { className: "graphiql-response" },
                                ...
                                footer)))))),
        react_1.default.createElement(react_2.Dialog, { isOpen: showDialog === 'short-keys', onDismiss: handleDismissShortKeysDialog },
            react_1.default.createElement("div", { className: "graphiql-dialog-header" },
                ...
                react_1.default.createElement(react_2.Dialog.Close, { onClick: handleDismissShortKeysDialog })),
            react_1.default.createElement("div", { className: "graphiql-dialog-section" },
                react_1.default.createElement("div", null,
                    ...
                    react_1.default.createElement("p", null,
                        ...
                        ".")))),
        react_1.default.createElement(react_2.Dialog, { isOpen: showDialog === 'settings', onDismiss: handleDismissSettingsDialog },
            react_1.default.createElement("div", { className: "graphiql-dialog-header" },
                react_1.default.createElement("div", { className: "graphiql-dialog-title" }, "Settings"),
                react_1.default.createElement(react_2.Dialog.Close, { onClick: handleDismissSettingsDialog })),
            ...
            storageContext ? (react_1.default.createElement("div", { className: "graphiql-dialog-section" },
                ...
                react_1.default.createElement("div", null,
                    react_1.default.createElement(react_2.Button, { type: "button", state: clearStorageStatus || undefined, disabled: clearStorageStatus === 'success', onClick: handleClearData }, clearStorageStatus === 'success'
                        ? 'Cleared data'
